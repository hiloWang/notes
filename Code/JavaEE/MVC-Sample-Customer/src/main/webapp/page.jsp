...
<a href="${pageContext.request.contextPath}${page.url}&pageNum=${page.previousPage}">上一页</a>&nbsp;&nbsp;

<c:forEach begin="${page.startPageNum}" end="${page.endPageNum}" var="num">
    <a href="${pageContext.request.contextPath}${page.url}&pageNum=${num}">${num }</a>
</c:forEach>

<a href="${pageContext.request.contextPath}${page.url}&pageNum=${page.nextPage}">下一页</a>&nbsp;&nbsp;
