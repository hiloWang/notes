...
<head>
    ...
    <script type="text/javascript">
        ...
        function addCart() {
            ...
            location.href = "${pageContext.request.contextPath}/product?action=addProductToCart&pid=${product.pid}&buyNum=" + buyNum;
        }
...
<div class="container">
    <div class="row">
        <div style="border: 1px solid #e4e4e4; width: 930px; margin: 0 auto; padding: 10px; margin-bottom: 10px;">
