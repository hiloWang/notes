/*
 ...
 Description : 演示了 lseek()与
read()、write()的协作使用。该程序的第一个命令行参数为 将要打开的文件名称，
 余下的参数则指定了在文件上执行的输入/输出操作。每个表示操作的
...
- ./Code test.txt s10000 wabc：打开test.txt文件，移动偏移量到10000，然后写入abc。
 ============================================================================
 */
